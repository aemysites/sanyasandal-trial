...
## Environments
- Preview: https://main--sanyasandal-trial--aemysites.aem.page/
- Live: https://main--sanyasandal-trial--aemysites.aem.live/
...
1. Open the `sanyasandal-trial` directory in your favorite IDE and start coding :)
